...
const projects = [
  ...
  {
    title: "Classificador de Emails Inteligente",
    description: "Automação com LLMs para triagem e categorização inteligente de comunicações corporativas, otimizando fluxos de trabalho.",
  ...
  },
  {
    ...
    description: "Controle de gastos residenciais completo com dashboards estratégicos e modelagem relacional avançada.",
    tech: [".NET Core", "React", "TypeScript", "SQL Server"],
